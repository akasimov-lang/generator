...
with sync_playwright() as p:
    ...
    assert 'hue-rotate' in legend.locator('.menuReadyMedal.isGold').evaluate('(el) => getComputedStyle(el).filter')
    assert 'hue-rotate' in legend.locator('.menuReadyMedal.isRed').evaluate('(el) => getComputedStyle(el).filter')
    assert 'grayscale' in legend.locator('.isUnchecked .menuReadyMedal').evaluate('(el) => getComputedStyle(el).filter')
