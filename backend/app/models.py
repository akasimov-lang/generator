...
class Site(Base, TimestampMixin):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    menu_warning: Mapped[str | None] = mapped_column(String(40), nullable=True)
    core_update_notice: Mapped[str | None] = mapped_column(String(160), nullable=True)
    core_update_acknowledged: Mapped[str | None] = mapped_column(String(160), nullable=True)
...
class Section(Base, TimestampMixin):
    ...
    is_review: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="false")
...
class ContentRevision(Base, TimestampMixin):
    ...
    source_status: Mapped[str] = mapped_column(String(40), default="generated", server_default="generated")
    is_published_replacement: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
