...
def test_gemini_content_generation_passes_competitor_brief_to_prompt(monkeypatch) -> None:
            ...
            "candidates": [
                {
                    "content": {
                        "parts": [
                            {
                                "text": (
                                    "Title: Detailed casino comparison guide for safer player choices\n"
    ...
    assert generated_with_separate_title["pages"][0]["title"] == "Detailed casino comparison guide for safer player choices"
